...
try {
    ...
    $sql = "CREATE TABLE IF NOT EXISTS category_post  ( `item_id ` INT UNSIGNED NOT NULL AUTO_INCREMENT , `name` VARCHAR(255) NOT NULL , `description` VARCHAR(100) NOT NULL , PRIMARY KEY (item_id), FOREIGN KEY (category_id) REFERENCES categories (category_id),FOREIGN KEY (sub_id) REFERENCES categories (sub_id) ";
